// All Indian States, Union Territories, and their Districts
export const indiaData: Record<string, string[]> = {
  'Andhra Pradesh': [
    ...
    'Parvathipuram Manyam', 'Prakasam', 'Sri Balaji', 'Sri Sathya Sai',
  ...
  'Madhya Pradesh': [
    ...
    'Neemuch', 'Niwari', 'Panna', 'Pandhurna', 'Raisen', 'Rajgarh',
  ...
  'Rajasthan': [
    ...
    'Dudu', 'Gangapur City', 'Hanumangarh', 'Jaipur', 'Jaipur Rural',
    'Jaisalmer', 'Jalore', 'Jhalawar', 'Jhunjhunu', 'Jodhpur', 'Jodhpur Rural',
    'Karauli', 'Kekri', 'Kota', 'Kotputli-Behror', 'Nagaur', 'Neem Ka Thana',
...
export const allStates = Object.keys(indiaData).sort();
